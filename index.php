    ...
    <div id="cart-drawer">
        ...
        <div class="cart-paper">
            <div class="cart-header">
                ...
                <label for="cart-drawer" class="small-font">0 items</label>
                </div>
            <button id="cartCloseBtn" type="button" class="close" aria-label="Close Cart">
            ...
            <div class="cart-body-wrapper">
                <div class="cart-body">
                    <div class="cart-product-card">
                        <div class="cart-product-card-header d-flex flex-row justify-content-between">
                            ...
                            <button id="cartCloseBtn" type="button" class="close small-font" aria-label="Close Cart">
                                <span aria-hidden="true">Remove</span>
                            </button>
                        </div>
                        <div class="cart-product-card-content d-flex flex-row">
                            <img src="/media/sprint_bullet_icon.jpg" alt="" class="cart-product-image">
                            <div class="cart-product-description">
                            <p>Product Description</p>
                            <div class="cart-product-card-bottom">
                                <span class="small-font font-weight-bold">$50</span>
                                <div class="cart-product-quantity">
                                    <button class="minus-button disable_button_bacground"></button>
                                    <input class="cart-product-quantity-amount disable_button_bacground text-center" value="1"/>
                                    <button class="plus-button disable_button_bacground"></button>
                                </div>
                            </div>
                            </div>
                        </div>
                ...
                <div class="cart-checkout">
                    ...
                    <div class="cart-checkout-proceed d-flex flex-column align-items-center">
                        <button class="btn btn-primary text-uppercase mb-2">Proceed to Checkout</button>
