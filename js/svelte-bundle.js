...
var app = (function () {
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			em = element("em");
    			em.textContent = "No content provided";
    			add_location(em, file, 24, 8, 735);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "cart-paper svelte-6l8lcx");
    			add_location(div, file, 22, 0, 691);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	validate_slots('CartDrawer', slots, ['default']);
